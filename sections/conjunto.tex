...
\begin{itemize}
    ...
    Si. Es único.\footnote{Se puede consultar la demostración en el anexo}
    ...
    Si. Un mínimo es siempre minimal también.\footnote{Se puede consultar la demostración en el anexo}
