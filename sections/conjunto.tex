...
El conjunto $\mathcal{O}$ corresponde al conjunto de todas las funciones tales que
\[ \exists c > 0 , n_0 . \forall n \geq n_0 . f(n) \leq c \cdot g(n) \]
En otras palabras, corresponde a todas las funciones tales que al ponderarlas por algún valor positivo, estas sean mayores que $g(n)$ desde algún punto en adelante
